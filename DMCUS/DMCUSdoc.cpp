...
DMCUSDoc::DMCUSDoc(MainWindow *App_, const QString& Name_)
{
  App = App_;
...
QString DMCUSDoc::fileSuffix (const QString& Name) {
  QFileInfo Info (Name);
  return Info.suffix();
}

QString DMCUSDoc::fileSuffix (void) {
  return fileSuffix (DocName);
}

QString DMCUSDoc::fileBase (const QString& Name) {
  QFileInfo Info (Name);
  return Info.completeBaseName();
}

QString DMCUSDoc::fileBase (void) {
